...
def fitClassifier(classifier, training_set, test_set):
    ...
    #history = classifier.fit(training_set, epochs=10, steps_per_epoch=16, validation_data=test_set, validation_steps=10)
...
def compareModel(new_model, test_set):
    ...
    score = old_model.evaluate(test_set,
                               steps=nb_validation_samples // batch_size)
    new_score = new_model.evaluate(test_set,
                                   steps=nb_validation_samples // batch_size)
